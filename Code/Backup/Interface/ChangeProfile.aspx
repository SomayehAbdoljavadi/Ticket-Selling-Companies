...
<asp:Content ID="Content2" ContentPlaceHolderID="CphMain" runat="Server">
    <table width="100%">
        ...
        <tr>
            <td>
                <asp:Label ID="Label9" runat="server" Text="رمز عبور قبلی : "></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td class="style1">
                <asp:Label ID="Label8" runat="server" Text="تکرار رمز عبور جدید : "></asp:Label>
            </td>
            <td>
