...
namespace DCL
{
    ...
    {
        DAL.FilterOperators dal = new DAL.FilterOperators();
        public DML.FilterOperators dml = new DML.FilterOperators();


        private DataTable dataTable;

        public DataTable Select(DML.FilterOperators entity)
        {
            try
            {
        ...
        public DML.FilterOperators Select(Object id)
        {
            if (id == null)
        ...
        public bool Delete(Object id)
        {
            ...
            try
            {
                ...
                dal.Delete(_id);
                if (dal.SelectById(_id).code == _id)
                    ret = false;
            }
            catch (Exception exp)
            {
        ...
        public bool Delete(DML.FilterOperators entity)
        {
            if (entity == null)
        ...
        public bool Update(DML.FilterOperators entity)
        {
            if (entity == null)
                throw new ArgumentNullException("The Argument Cannot Be Null!");
        ...
        private String getFilterOptionCode(DML.FilterOperators entity)
        {
            try
            {
                StringBuilder sb = new StringBuilder("");
                sb.Append(FilterOperatorValue.GetValue(entity.FilterOption["code"])).Append("-");
                sb.Append(FilterOperatorValue.GetValue(entity.FilterOption["text"]));
                return sb.ToString();
            }
            catch (Exception exp)
            {
        ...
        public bool CheckEntityValidity(DML.FilterOperators entity)
        {
            try
            {
                bool ret = true;
                ret = ret && ((entity.code != null) || entity.AllowNull["code"]);
                ret = ret && ((entity.text != null) || entity.AllowNull["text"]);
                return ret;
            }
            catch (Exception exp)
            {
        ...
        public DML.FilterOperators CreateEntity(Object code, Object text)
        {
            DML.FilterOperators entity = new DML.FilterOperators();
            try
            {
                ...
                if (text != null && text.ToString() != "")
                    entity.text = Convert.ToString(text);
        ...
        //public DML.FilterOperators AddEntity(DML.FilterOperators entity)
        //{
        //    if(entity.code != null)
        //        this.dml.code = entity.code;
        //    if(entity.text != null)
        //        this.dml.text = entity.text;
