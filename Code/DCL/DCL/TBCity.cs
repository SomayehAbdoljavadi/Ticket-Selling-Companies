...
namespace DCL
{
    public class TBCity
    {
        DAL.TBCity dal = new DAL.TBCity();
        public DML.TBCity dml = new DML.TBCity();


        private DataTable dataTable;

        public DataTable Select(DML.TBCity entity)
        {
            try
            {
        ...
        public DML.TBCity Select(Object id)
        {
            if (id == null)
        ...
        public bool Delete(DML.TBCity entity)
        {
            if (entity == null)
        ...
        public bool Update(DML.TBCity entity)
        {
            if (entity == null)
                throw new ArgumentNullException("The Argument Cannot Be Null!");
        ...
        private String getFilterOptionCode(DML.TBCity entity)
        {
            try
            {
                StringBuilder sb = new StringBuilder("");
                sb.Append(FilterOperatorValue.GetValue(entity.FilterOption["ID"])).Append("-");
                sb.Append(FilterOperatorValue.GetValue(entity.FilterOption["CountryID"])).Append("-");
                sb.Append(FilterOperatorValue.GetValue(entity.FilterOption["Name"]));
                return sb.ToString();
            }
            catch (Exception exp)
            {
        ...
        public bool CheckEntityValidity(DML.TBCity entity)
        {
            try
            {
                bool ret = true;
                ret = ret && ((entity.ID != null) || entity.AllowNull["ID"]);
                ret = ret && ((entity.CountryID != null) || entity.AllowNull["CountryID"]);
        ...
        public DML.TBCity CreateEntity(Object ID, Object CountryID, Object Name)
        {
            DML.TBCity entity = new DML.TBCity();
            try
            {
                ...
                if (CountryID != null && CountryID.ToString() != "")
                    entity.CountryID = Convert.ToInt32(CountryID);
        ...
        public DML.TBCity AddEntity(DML.TBCity entity)
        {
            if (entity.ID != null)
                this.dml.ID = entity.ID;
            if (entity.CountryID != null)
                this.dml.CountryID = entity.CountryID;
            if (entity.Name != null)
